...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<merb-action-args>, [">= 1.0"])
      s.add_runtime_dependency(%q<merb-assets>, [">= 1.0"])
      s.add_runtime_dependency(%q<merb-slices>, [">= 1.0"])
      s.add_runtime_dependency(%q<merb-auth>, [">= 1.0"])
      s.add_runtime_dependency(%q<merb-cache>, [">= 1.0"])
      s.add_runtime_dependency(%q<merb-exceptions>, [">= 1.0"])
      s.add_runtime_dependency(%q<merb-gen>, [">= 1.0"])
      s.add_runtime_dependency(%q<merb-haml>, [">= 1.0"])
      s.add_runtime_dependency(%q<merb-helpers>, [">= 1.0"])
      s.add_runtime_dependency(%q<merb-mailer>, [">= 1.0"])
      s.add_runtime_dependency(%q<merb-param-protection>, [">= 1.0"])
      s.add_runtime_dependency(%q<merb_datamapper>, [">= 1.0"])
    else
      s.add_dependency(%q<merb-core>, [">= 1.0"])
      s.add_dependency(%q<merb-action-args>, [">= 1.0"])
      s.add_dependency(%q<merb-assets>, [">= 1.0"])
      s.add_dependency(%q<merb-slices>, [">= 1.0"])
      s.add_dependency(%q<merb-auth>, [">= 1.0"])
      s.add_dependency(%q<merb-cache>, [">= 1.0"])
      s.add_dependency(%q<merb-exceptions>, [">= 1.0"])
      s.add_dependency(%q<merb-gen>, [">= 1.0"])
      s.add_dependency(%q<merb-haml>, [">= 1.0"])
      s.add_dependency(%q<merb-helpers>, [">= 1.0"])
      s.add_dependency(%q<merb-mailer>, [">= 1.0"])
      s.add_dependency(%q<merb-param-protection>, [">= 1.0"])
      s.add_dependency(%q<merb_datamapper>, [">= 1.0"])
    end
  else
    s.add_dependency(%q<merb-core>, [">= 1.0"])
    s.add_dependency(%q<merb-action-args>, [">= 1.0"])
