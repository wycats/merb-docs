...
Gem::Specification.new do |s|
  ...
  s.files = ["AUTHORS", "CHANGES", "LICENSE", "README", "Rakefile", "ext/breakpoint.c", "ext/extconf.rb", "ext/ruby_debug.c", "ext/ruby_debug.h", "ext/win32/ruby_debug.so", "lib/ChangeLog", "lib/ruby-debug-base.rb", "test/base/base.rb", "test/base/binding.rb", "test/base/catchpoint.rb"]
  s.has_rdoc = true
