...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "README", "Rakefile", "TODO", "lib/merb-action-args.rb", "lib/merb-action-args", "lib/merb-action-args/get_args.rb", "lib/merb-action-args/abstract_controller.rb", "lib/merb-action-args/jruby_args.rb", "spec/controllers", "spec/controllers/action-args.rb", "spec/action_args_spec.rb", "spec/spec_helper.rb"]
  s.has_rdoc = true
